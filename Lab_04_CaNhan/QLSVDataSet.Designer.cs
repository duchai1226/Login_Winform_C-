...
namespace Lab_04_CaNhan.QLSVDataSetTableAdapters {
    ...
    public partial class NHANVIENTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[NHANVIEN] WHERE (([MANV] = @Original_MANV) AND ([HOTEN] = @Ori" +
                ...
                "l_EMAIL)) AND ([TENDN] = @Original_TENDN))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[NHANVIEN] SET [MANV] = @MANV, [HOTEN] = @HOTEN, [EMAIL] = @EMAIL, [LUONG] = @LUONG, [TENDN] = @TENDN, [MATKHAU] = @MATKHAU WHERE (([MANV] = @Original_MANV) AND ([HOTEN] = @Original_HOTEN) AND ((@IsNull_EMAIL = 1 AND [EMAIL] IS NULL) OR ([EMAIL] = @Original_EMAIL)) AND ([TENDN] = @Original_TENDN));
SELECT MANV, HOTEN, EMAIL, LUONG, TENDN, MATKHAU FROM NHANVIEN WHERE (MANV = @MANV)";
        ...
        public virtual int Delete(string Original_MANV, string Original_HOTEN, string Original_EMAIL, string Original_TENDN) {
        ...
        public virtual int Update(string MANV, string HOTEN, string EMAIL, byte[] LUONG, string TENDN, byte[] MATKHAU, string Original_MANV, string Original_HOTEN, string Original_EMAIL, string Original_TENDN) {
            if ((MANV == null)) {
                throw new global::System.ArgumentNullException("MANV");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string HOTEN, string EMAIL, byte[] LUONG, string TENDN, byte[] MATKHAU, string Original_MANV, string Original_HOTEN, string Original_EMAIL, string Original_TENDN) {
            return this.Update(Original_MANV, HOTEN, EMAIL, LUONG, TENDN, MATKHAU, Original_MANV, Original_HOTEN, Original_EMAIL, Original_TENDN);
        }
    }
